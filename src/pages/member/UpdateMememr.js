...
export const UpdateMember = () => {
  ...
  const onFinish = async (values) => {
    ...
    const formData = {
      ...
      benefitType: benefitType ? benefitType : users.benefitType,
      memberType: memberType ? memberType : users.memberType,
      graduate_date: graduate_date ? graduate_date : users.graduate_date,
      employ_type: employ_type ? employ_type : users.employ_type,
      year: year ? year : users.year,
